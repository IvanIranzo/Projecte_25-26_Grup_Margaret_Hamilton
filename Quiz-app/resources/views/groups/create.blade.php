...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="{{ route('groups.store') }}" method="POST" class="bg-white rounded-lg shadow p-6 max-w-lg">
        @csrf
        ...
        <div class="flex space-x-3">
            ...
            <a href="{{ route('groups.index') }}" class="bg-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-400">
                Cancel
            </a>
        </div>
    </form>
