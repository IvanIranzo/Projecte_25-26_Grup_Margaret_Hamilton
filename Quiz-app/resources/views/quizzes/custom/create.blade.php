...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <form action="{{ route('custom.quiz.store') }}" method="POST" id="quizForm">
            @csrf
                    ...
                    <div class="options-container">
                        ...
                        <div id="options-0">
                            ...
                            <div class="flex items-center mb-2">
                                <input type="text" name="questions[0][options][{{ $i }}][content]" required class="flex-1 px-3 py-2 border rounded-lg mr-2" placeholder="Option {{ $i+1 }}">
                                <label class="flex items-center">
                                    <input type="checkbox" name="questions[0][options][{{ $i }}][is_correct]" value="1" class="mr-1">
